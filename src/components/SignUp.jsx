...
const SignUp = ({ setLoginform, setregiform, loginform, regiform }) => {
        ...
        <div className="mt-28 ml-8 flex flex-wrap flex-col">
          ...
          <div className="md:ml-8  justify-center items-start ml-0">
            ...
            <div className="mt-3 mb-3">
              ...
              <button
                className="btn shadow-md hover:!text-gray-900 text-gray-950 px-5"
                onClick={() => setrole("")}
              >
                Back
              </button>
  ...
  return (
    <>
      {role.length === 0 && (
        <div className="mt-28 ml-8 flex flex-wrap flex-col">
          <p className="text-gray-700 font-medium text-2xl md:text-4xl">
          ...
          <div className="mt-3">
            ...
            <label
              htmlFor="student"
              className="text-gray-700 ml-2 mr-[5rem] font-medium text-xl mt-0 md:text-2xl"
            >
              Student
            </label>
            ...
            <label
              htmlFor="trainer"
              className="text-gray-700 ml-2 font-medium text-xl mt-0 md:text-2xl"
            >
              Trainer
            </label>
          </div>
